...
/**  this clas is used for showing the cart in the webpage
 *   in real time with manupulaiton of the user
 **/
public class Cart_servlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (action != null && action.equals("add")) {
            ...
            List<Product_details> items = cart.getProducts();
            for (Product_details item : items) {
            ...
            if (!productExists) {
                cart.addProduct(new Product_details(name, price, 1));
            }
        }
        ...
        for (Product_details item : items) {
            out.println("<tr>" +
                    ...
                    "<input type='hidden' name='price' value='" + item.get_Price() + "'>" +
