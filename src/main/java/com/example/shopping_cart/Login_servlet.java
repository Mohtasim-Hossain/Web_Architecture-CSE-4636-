...
/**
 * This servlet will handle the login information provided by the client
...
public class Login_servlet extends HttpServlet {
     ...
     * enters in the login page and matches it to "Mohtasim" and "test1234"
     * respectively. If the credentials are correct, then the
     ...
     * Product_servlet. The reason we are not redirecting the user to
     ...
     * which we use a servlet (Product_servlet) to at first authenticate the
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (username.equals("Mohtasim") && password.equals("test1234"))
        {
